...
class DataGenSequence(Sequence):
    ...
    def __getitem__(self, idx):
        ...
        batch_text_input = sequence.pad_sequences(text_input, maxlen=max_token_length,
                                                  padding='post')  # 将text_input序列转化为经过填充的等长的新序列，max_token_length为序列的最大长度，当需要补0时在序列的结尾补
