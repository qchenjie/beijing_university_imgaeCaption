...
from tensorflow.keras.layers import Input, Dense, LSTM, Concatenate, Embedding, RepeatVector, TimeDistributed, Dropout
...
from config import max_token_length #40
from config import vocab_size, embedding_size


#这里关于升维，降维还有none,enbedding的用法我都写到了有道云中了
...
if __name__ == '__main__':
    ...
    # 打印模型结构,之前就是这句话有毛病，之前是model.svg，改成png就可以了。
